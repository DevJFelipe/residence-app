...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget _buildBottomNav(BuildContext context) {
    final navItems = [
      {'icon': 'assets/icons/wnav_explore.svg', 'label': 'EXPLORAR', 'active': true, 'w': 20.0, 'h': 20.0},
      {'icon': 'assets/icons/wnav_payments.svg', 'label': 'PAGOS', 'active': false, 'w': 18.0, 'h': 20.0},
      {'icon': 'assets/icons/wnav_notices.svg', 'label': 'AVISOS', 'active': false, 'w': 16.0, 'h': 20.0},
      {'icon': 'assets/icons/wnav_profile.svg', 'label': 'PERFIL', 'active': false, 'w': 20.0, 'h': 20.0},
    ];
